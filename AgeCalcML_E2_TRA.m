%% AGECALCML_E2_TRA MATLAB code for AgeCalcML_E2_TRA.fig %%
...
function varargout = AgeCalcML_E2_TRA_OutputFcn(hObject, eventdata, H)
...
%for i = 1:data_count
%	M235ap_tmp(:,i) = M235ap(6+(i-1)*54:16+(i-1)*54,1);
%end
...
%{
for i = 1:length(numbers(:,1))-1
	if M235ap(i,1) < 500 && M235ap(i+1,1) > 500 && M235ap(i-1,1) < 500 && M235ap(i+2,1) > 500 && M235ap(i-2,1) < 500 && M235ap(i+3,1) > 500
		t0(i,1) = 1;
		t0idx(i,1) = i;
	else
		t0(i,1) = 0;
