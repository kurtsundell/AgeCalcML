...
Results_IN = getappdata(0,'Results_OUT');



set(H.uitable1,'Data',Results_IN)
...
set(H.xvals1,'Value',7)
set(H.xvals2,'Value',2)
set(H.yvals1,'Value',26)
...
data_tmp(cellfun(@isempty, data_tmp)) = {nan};
...
if get(H.discriminationdiagrams,'Value') == 2
	...
	imshow(image1, [], 'XData', [str2double(get(H.xmin,'String')) str2double(get(H.xmax,'String'))], 'YData', [str2double(get(H.ymax,'String')) str2double(get(H.ymin,'String'))]);
	set(gca,'YDir','normal')
	axis on
end
