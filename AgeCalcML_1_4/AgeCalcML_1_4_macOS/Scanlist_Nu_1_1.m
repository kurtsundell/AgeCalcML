function varargout = Scanlist_Nu_1_1(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',mfilename,'gui_Singleton',gui_Singleton,'gui_OpeningFcn', @Scanlist_Nu_1_1_OpeningFcn,'gui_OutputFcn',@Scanlist_Nu_1_1_OutputFcn,'gui_LayoutFcn',[],'gui_Callback',[]);
...
function Scanlist_Nu_1_1_OpeningFcn(hObject, eventdata, H, varargin)
H.output = hObject;
H.run = 0;
guidata(hObject, H);

function varargout = Scanlist_Nu_1_1_OutputFcn(hObject, eventdata, H) 
...
if get(H.num_unknowns, 'Value') == 3
	...
	Unknowns = Names(1:n); 
	FCs_tmp = Names(121:154); 
	R33s_tmp = Names(155:158);
