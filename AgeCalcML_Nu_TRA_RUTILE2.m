%% AGECALCML_NU_TRA_RUTILE2 MATLAB code for AgeCalcML_Nu_TRA_RUTILE2.fig %%
function varargout = AgeCalcML_Nu_TRA_RUTILE2(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',mfilename,'gui_Singleton',gui_Singleton,'gui_OpeningFcn', @AgeCalcML_Nu_TRA_RUTILE2_OpeningFcn,'gui_OutputFcn',@AgeCalcML_Nu_TRA_RUTILE2_OutputFcn,'gui_LayoutFcn',[],'gui_Callback',[]);
...
function AgeCalcML_Nu_TRA_RUTILE2_OpeningFcn(hObject, eventdata, H, varargin)
H.output = hObject;
set(H.WM_STD2,'Visible','off')
guidata(hObject, H);
function varargout = AgeCalcML_Nu_TRA_RUTILE2_OutputFcn(hObject, eventdata, H)
...
if get(H.secondary,'Value') == 1
	WM_Data_hi = 489.34 + 489.34*str2num(get(H.percdev,'String'))*.01;
	WM_Data_lo = 489.34 - 489.34*str2num(get(H.percdev,'String'))*.01;
end
...
if sum(STD2_idx) > 1
	...
	if get(H.secondary,'Value') == 1	
		age_label3_x = 0.61858;
		age_label3_y = 0.078872;
		age_label3 = {'489.3 Ma'};
	end
...
% --- Executes on button press in corr208.
function corr208_Callback(hObject, eventdata, handles)
% hObject    handle to corr208 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of corr208


% --- Executes on button press in corr207.
function corr207_Callback(hObject, eventdata, handles)
% hObject    handle to corr207 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of corr207
