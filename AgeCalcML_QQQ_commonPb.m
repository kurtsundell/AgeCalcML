%% AGECALCML_QQQ_COMMONPB MATLAB code for AgeCalcML_QQQ_commonPb.fig %%
function varargout = AgeCalcML_QQQ_commonPb(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',mfilename,'gui_Singleton',gui_Singleton,'gui_OpeningFcn', @AgeCalcML_QQQ_commonPb_OpeningFcn,'gui_OutputFcn',@AgeCalcML_QQQ_commonPb_OutputFcn,'gui_LayoutFcn',[],'gui_Callback',[]);
...
function AgeCalcML_QQQ_commonPb_OpeningFcn(hObject, eventdata, H, varargin)
H.output = hObject;
set(H.WM_STD2,'Visible','off')
guidata(hObject, H);
function varargout = AgeCalcML_QQQ_commonPb_OutputFcn(hObject, eventdata, H)
...
values = values_all(1:28,1:9,name_idx);
