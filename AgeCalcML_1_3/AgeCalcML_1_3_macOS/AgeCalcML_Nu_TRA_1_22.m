...
elseif get(H.method,'Value') == 2 % 300/hour
		...
		end_idx = t0_idx + 46; 
	if IC == 1
		start_idx_IC1 = t0_idx - 13;
		end_idx_IC1 = t0_idx + 46;
		start_idx_IC2 = t0_idx - 14;
		end_idx_IC2 = t0_idx + 45;
		start_idx_IC3 = t0_idx - 15;
		end_idx_IC3 = t0_idx + 44;
	end 
	samp_length = 60;
	for i = 1:data_count
		values_all(1:samp_length,1:cols,i) = values_tmp(start_idx(i,1):end_idx(i,1),1:cols);
	...
	if IC == 1
		for i = 1:data_count
			values_all_IC1(1:samp_length,4:7,i) = values_tmp(start_idx_IC1(i,1):end_idx_IC1(i,1),4:7);
			baseline_IC1(1:12,4:7,i) = values_all(1:12,4:7,i);
			integration_IC1(1:35,4:7,i) = values_all(16:50,4:7,i);
		end
		
		for i = 1:data_count
			values_all_IC2(1:samp_length,4:7,i) = values_tmp(start_idx_IC2(i,1):end_idx_IC2(i,1),4:7);
			baseline_IC2(1:12,4:7,i) = values_all(1:12,4:7,i);
			integration_IC2(1:35,4:7,i) = values_all(16:50,4:7,i);
		end
		
		for i = 1:data_count
			values_all_IC3(1:samp_length,4:7,i) = values_tmp(start_idx_IC3(i,1):end_idx_IC3(i,1),4:7);
			baseline_IC3(1:12,4:7,i) = values_all(1:12,4:7,i);
			integration_IC3(1:35,4:7,i) = values_all(16:50,4:7,i);
		end	
