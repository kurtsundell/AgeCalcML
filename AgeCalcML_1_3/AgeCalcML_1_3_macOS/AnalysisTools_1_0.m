function varargout = AnalysisTools_1_0(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name', mfilename, 'gui_Singleton',  gui_Singleton, 'gui_OpeningFcn', @AnalysisTools_1_0_OpeningFcn, 'gui_OutputFcn',  @AnalysisTools_1_0_OutputFcn, 'gui_LayoutFcn',  [] , ...
                   'gui_Callback', []);
...
function AnalysisTools_1_0_OpeningFcn(hObject, eventdata, H, varargin)
imshow('splashs_eQh_icon.ico', 'Parent', H.axes1);
H.output = hObject;
guidata(hObject, H);

function varargout = AnalysisTools_1_0_OutputFcn(hObject, eventdata, H) 
varargout{1} = H.output;

function concordia_Callback(hObject, eventdata, H)
ConcordiaPlotter_1_0

function stackedconc_Callback(hObject, eventdata, H)
StackedConcordiaPlotter_1_0

function dist_Callback(hObject, eventdata, H)
DistributionPlotter_1_0

function stackeddist_Callback(hObject, eventdata, H)
StackedDistributionPlotter_1_0

function wm_Callback(hObject, eventdata, H)
