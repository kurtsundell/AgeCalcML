function varargout = HafniumPlotter_1_6(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name', mfilename,'gui_Singleton',  gui_Singleton,'gui_OpeningFcn', @HafniumPlotter_1_6_OpeningFcn,'gui_OutputFcn',  @HafniumPlotter_1_6_OutputFcn, ...
...
function HafniumPlotter_1_6_OpeningFcn(hObject, eventdata, H, varargin)
H.output = hObject;
view([-37.5, 30]);
set(H.d3,'Value',1)
...
function varargout = HafniumPlotter_1_6_OutputFcn(hObject, eventdata, H) 
...
data = importdata(char(strcat(pathname, filename)),',',500000);
