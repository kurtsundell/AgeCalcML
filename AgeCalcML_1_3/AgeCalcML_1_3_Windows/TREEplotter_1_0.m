function varargout = TREEplotter_1_0(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name', mfilename,'gui_Singleton',  gui_Singleton,'gui_OpeningFcn', @TREEplotter_1_0_OpeningFcn,'gui_OutputFcn',  @TREEplotter_1_0_OutputFcn, ...
...
function TREEplotter_1_0_OpeningFcn(hObject, eventdata, H, varargin)
H.output = hObject;
...
function varargout = TREEplotter_1_0_OutputFcn(hObject, eventdata, H) 
