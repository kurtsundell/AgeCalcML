function varargout = Scanlist_Nu(varargin)
gui_Singleton = 1;
gui_State = struct('gui_Name',mfilename,'gui_Singleton',gui_Singleton,'gui_OpeningFcn', @Scanlist_Nu_OpeningFcn,'gui_OutputFcn',@Scanlist_Nu_OutputFcn,'gui_LayoutFcn',[],'gui_Callback',[]);
...
function Scanlist_Nu_OpeningFcn(hObject, eventdata, H, varargin)
H.output = hObject;
H.run = 0;
guidata(hObject, H);

function varargout = Scanlist_Nu_OutputFcn(hObject, eventdata, H) 
